# Arquivo: views/view_portal_funcionario.py (Versão final com PDF e correções)
...
# Importa nossa função de geração de PDF da pasta utils
...
class PortalFuncionarioApp(tk.Toplevel):
    ...
    # ... (o resto das funções como create_tabs, carregar_dados_do_banco, etc. continuam aqui, sem alterações) ...
